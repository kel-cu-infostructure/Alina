...
public class Skip extends AbstractCommand {
    public Skip() {
        super("skip", Alina.localization.getLocalization("command.skip.description"));
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        scheduler.nextTrack();
        event.replyEmbeds(new EmbedBuilder().setDescription(Alina.localization.getLocalization("command.skip.done")).setColor(DEFAULT).build()).setEphemeral(false).queue();
    }
}
